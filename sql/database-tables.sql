...
--
-- Host: localhost
-- Generation Time: Feb 19, 2014 at 03:14 PM
...
--
-- Table structure for table `mantis_bug_vote_table`
--

CREATE TABLE IF NOT EXISTS `mantis_bug_vote_table` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `bug_id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL,
